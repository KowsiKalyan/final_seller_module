    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          tempList.clear();
          mediaList.clear();
          Future.delayed(const Duration(seconds: 2), getMedia);
              ...
              selectedImageFromGellery == null
                  ...
                  : InkWell(
                      onTap: () {
                        ...
                        isImageUploading;
                        setState(() {});
                        isImageUploading ? "" : uploadMediaAPI();
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          color: primary,
                      ...
                      mediaList.forEach(
                        (element) {
                          if (element.isSelected) {
                            add.otherPhotos.add(element.path!);
                            add.otherImageUrl.add(element.image!);
                          }
                        },
                      );
                    }
        ...
        onTap: () {
          setState(
            () {
              ...
              if (widget.from == "main") {
                if (widget.type == "add") {
                  currentSelectedName = mediaList[index].id!;
                  add.productImage =
