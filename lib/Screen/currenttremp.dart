        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              currentPage == 5 ? current_Page5() : Container(),
              // addProductName(),
              // shortDescription(),
              // tagsAdd(),
              // taxSelection(),
...
//============================= UI Part ========================================
  ...
  current_Page1() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        getPrimaryCommanText(getTranslated(context, "PRODUCTNAME_LBL")!),
        getCommanSizedBox(),
        ...
        getCommanSizedBox(),
        getPrimaryCommanText(getTranslated(context, "ShortDescription")!),
        getCommanSizedBox(),
        getCommanInputTextField(
        ...
        Row(
          children: [
            getPrimaryCommanText(getTranslated(context, "Tags")!),
        ...
        getCommanSizedBox(),
        getPrimaryCommanText(getTranslated(context, "Select Tax")!),
        getCommanSizedBox(),
        getCommanInputTextField(
          getTranslated(context, "Select Tax")!,
          4,
        ...
        getCommanSizedBox(),
        getPrimaryCommanText(getTranslated(context, "Select Indicator")!),
        getIconSelectionDesing("hii", 2),
        getCommanSizedBox(),
        getPrimaryCommanText(getTranslated(context, "Made In")!),
        getCommanSizedBox(),
        getIconSelectionDesing("hii", 2),
        getCommanSizedBox(),
      ],
  ...
  current_Page2() {
    return Row(
      children: [
        getPrimaryCommanText("title"),
        getPrimaryCommanText("title"),
        getPrimaryCommanText("title"),

        // getCommanInputTextField(
        //     "title", index, heightvalue, widthvalue, textType)
      ],
    );
  }

  current_Page3() {
    return const Text("New UI");
  }
...
// Comman Primary Text Field :-
  ...
  getPrimaryCommanText(String title) {
    return Text(
      title,
      style: const TextStyle(
        fontSize: 18,
