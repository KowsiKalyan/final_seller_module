                ...
                children: [
                  FloatingActionButton(
                    ...
                    onPressed: () async {
                      ...
                      if (Platform.isIOS) {
                        // for iOS phone only
                        if (await canLaunch(encoded.toString())) {
                          await launch(encoded.toString(),
                              forceSafariVC: false);
                        } else {
                          launch(encoded.toString(), forceSafariVC: false);
                        }
                      } else {
                        // android , web
                        if (await canLaunch(encoded.toString())) {
                  ...
                  FloatingActionButton(
                    ...
                    onPressed: () async {
                      ...
                      if (Platform.isIOS) {
                        // for iOS phone only
                        if (await canLaunch(iosencoded.toString())) {
                          await launch(iosencoded.toString(),
                              forceSafariVC: false);
                        } else {
                          launch(iosencoded.toString(), forceSafariVC: false);
                        }
                      } else {
                        // android , web
                        if (await canLaunch(androidencoded.toString())) {
                          await launch(androidencoded.toString());
                        } else {
                          launch(androidencoded.toString());
                        }
                      }
                      //await launch(uri);
                    },
